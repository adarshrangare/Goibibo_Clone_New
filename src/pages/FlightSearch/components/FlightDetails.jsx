        ...
        <div className="w-full px-4 my-4">
          ...
          <div className="flex flex-col">
            {flightDetails.duration ? (
              ...
              <div className="flex w-full my-6 gap-2 justify-between h-32 m-auto border-2 py-4 px-2 item-center rounded-xl border-dashed bg-gray-50 ">
                <div className="flightname w-full flex items-center justify-center flex-col text-xs text-slate-500 h-full ">
