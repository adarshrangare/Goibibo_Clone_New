        ...
        <div className="flex items-center justify-between  w-full">
          <div className="flex">
            <Rate
              ...
              value={rating}
              disabled
              className="scale-[.85] inline-block"
            />
