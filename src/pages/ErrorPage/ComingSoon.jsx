  ...
  return (
    <div className="w-full min-h-screen ">
      ...
      <div className="contains404  w-fit  my-4 mx-auto  p-4 bg-white border rounded-lg shadow-lg  ">
          <div class="message_404 text-center flex flex-col  items-center justify-center h-full">
            <div class="head404 p-4 font-bold text-6xl md:text-7xl text-center text-slate-400">
              Coming Soon
            </div>
            <div class="land404 text-2xl font-semibold my-2">Page is under construction </div>
            <div className="my-2 text-slate-600">
              We're sorry for inconvenience . This Section will be back soon.
            </div>
            <div class="links404 flex gap-4 text-blue-600 w-full items-center justify-center flex-wrap">
