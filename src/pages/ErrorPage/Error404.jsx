      ...
      <ContentWrapper>
        <div className="contains404  md:w-10/12 my-4 mx-auto">
          <div class="message_404 text-center flex flex-col  items-center justify-center h-full">
            <div class="head404 font-bold text-8xl md:text-9xl text-center text-slate-300">
              404
            </div>
            <div class="land404 text-2xl font-semibold my-2">You've landed in No Man's Land! </div>
            <div className="my-2 text-slate-600">
              We're sorry. The page that you are looking for does not exist
            </div>
            <div class="links404 flex gap-4 text-blue-600 w-full items-center justify-center">
