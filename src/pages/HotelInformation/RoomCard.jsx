...
const roomImage = {
  ...
  Double:{
    image1:'https://images.unsplash.com/photo-1530334580314-1e7a340426a0?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    image2:'https://images.unsplash.com/photo-1553444859-788c4b385b13?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  },
  Deluxe: {
    image1:
    ...
    <div className="RoomContainer bg-white border shadow-lg rounded-lg w-full p-2 my-4 flex flex-col md:flex-row md:w-9/12 mx-auto overflow-x-hidden">
      <div className="upperSection md:basis-[40%] md:border-r md:px-2">
        <h1 className="title relative font-semibold pb-3 text-slate-800 before:content[''] before:w-2.5 before:h-[80%] before:-left-5 before:rounded-3xl before:bg-orange-600 before:absolute  ">
          {room?.roomType === "Single" || room?.roomType === "Double" ? "Standard" : "Exclusive"}{" "}
          {room?.roomType} Room
        </h1>
      ...
      <div className="lowerSection flex w-full md:px-8">
        ...
        "
          ...
          <div className="text-xs text-slate-500">
           ...
           <button className=" mt-2 px-4 py-2 border-2 border-orange-600 text-orange-600 bg-transparent rounded-lg font-semibold uppercase hover:bg-orange-600 hover:text-white transition-all duration-300 active:bg-orange-700 active:border-orange-700">Select Room</button>     
