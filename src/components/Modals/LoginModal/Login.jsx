...
const Login = ({ toggleLoginModal }) => {
  ...
  return createPortal(
    <>
      ...
      <div className="fixed mx-auto bottom-0 shadow-all w-full bg-white h-fit py-4 rounded-t-3xl z-50 transition-all md:w-1/2  md:fixed md:p-4 md:text-center md:transform md:-translate-x-1/2 md:-translate-y-1/2  md:top-1/2 md:left-1/2 md:rounded-md md:shadow-xl z-12">
